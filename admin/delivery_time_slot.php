                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet box green">
                            <div class="portlet-title">
                                <div class="caption">Time Slot List</div>
                                <a class="dt-button buttons-print btn default" style="margin-left: 2%; margin-top: 0.4%;" href="./delivery_time_slot_add.php"> Add Delivery Time Slot
                                </a>
                            </div>
